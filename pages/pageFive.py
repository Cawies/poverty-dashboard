                ...
                [
                    ...
                    html.Div(
                        [
                            html.Div(
                                [
                                    html.Div(html.H5("Contact", style={"padding-left": "10px"}), className="inner-product2"),
                                    html.Br([]),
                ...
                [
                    ...
                    html.Div(
                        [
                            html.Div(
                                [
                                    html.Div(html.H5("Contact cont.", style={"padding-left": "10px"}), className="inner-product2"),
                                    html.Br([]),
                                    html.P(load_document(config.TEXT_FILE),
                                        style={"color": "#000000"},
                                        className="row",
